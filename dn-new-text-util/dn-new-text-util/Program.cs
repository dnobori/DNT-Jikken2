    ...
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            if (inputName.StartsWith("/") || inputName.StartsWith("!") || inputName.StartsWith("+"))
            {
                ...
                if (inputName.StartsWith("+"))
                {
                    txtBody = "\r\n\r\n\r\n\r\n【AI指示】 AI に対する出力指示: \r\n・ 調査・検索する際のサイトや情報源は、日本語に限らず、英語やその他の言語の情報源も広く用いてください。ただし、出力結果は、日本語で返してください。\r\n・ 出力される応答の末尾に必ず「===================================================================」という行 (区切り行) を出力してください。\r\n\r\nメモ用タグ (この行および以下の行は AI 処理の際には無視してください): " + yymmdd_and_tag + " \r\n\r\n===================================================================\r\n\r\nOpenAI 社 ChatGPT 5 Pro による推論出力結果:\r\n\r\n\r\n";
                }
                else
                {
